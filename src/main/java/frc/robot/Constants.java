...
public final class Constants {
  ...
  public static class Vision {
    ...
    public static final Function<PhotonPipelineResult, Matrix<N3, N1>> DEFAULT_VISIONSTDEV = x -> MatBuilder
        .fill(Nat.N3(), Nat.N1(), new double[] { 0.3, 0.3, Radian.convertFrom(999999999, Degrees) });
  ...
  public static class Hopper {
    ...
    public static final double SPINDEXER_RATIO = 1.0; // todo: change value, ratio of speed of spindexer to speed of
                                                      // intake rollers
  }
